const portfolioTabs = document.querySelector('.portfolio');

if (portfolioTabs) {
  const portfolioTabsNav = portfolioTabs.querySelector('.portfolio-tabs-nav');
  const portfolioTabsBtns = portfolioTabs.querySelectorAll('.portfolio-tabs-nav__btn');
  const portfolioTabsItems = portfolioTabs.querySelectorAll('.portfolio-tabs__item');
  const portfolioTabsItemsVisible = portfolioTabs.querySelectorAll('.portfolio-tabs__item--visible');
  const loadMore = portfolioTabs.querySelector('.portfolio-more');
  const maxItems = 9;
